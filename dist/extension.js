...
class BaseHandlerImpl {
  ...
  _handler;
  _always;
  constructor(name, handler, always = false) {
...
class ProxyHandlerImpl extends BaseHandlerImpl {
  static HINT = "proxy";
  _originName;
  constructor(handlerName, handler, originName, always = false) {
...
function getHandler(name, includeAlways = true) {
  const handlers = [];
...
var HEADER_HINT_NAME = "+x-cloud-functions-hint";
